...
void UHV4::BaudRate(const quint8 &baudrate)
{
    ...
    BaudrateValues.insert({BaudRate1200,BaudRate2400,BaudRate4800,BaudRate9600});
...
UHV4 &UHV4::Temperature(quint8 channel)
{
    ...
    ChannelTempValues.insert({CHANNELTEMP1,CHANNELTEMP2,CHANNELTEMP3,CHANNELTEMP4});
...
UHV4 &UHV4::Pressure(quint8 channel)
{
    ...
    ChannelValues.insert({CHANNEL1,CHANNEL2,CHANNEL3,CHANNEL4});
